...
from rl.evaluationinstance import evaluate
...
def main():
    ...
    parser.add_argument('--model_dir', type=str, default='trained_models/my_model_Round1')
    ...
    parser.add_argument('--test_model', type=str, default='32400.pt')
