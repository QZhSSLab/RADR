...
def run_evaluation(test_model):
    ...
    if test_args.visualize:
        ...
        log_file = os.path.join(test_args.model_dir, 'test', 'test_' + test_model + '.log')
    ...
    load_path = os.path.join(test_args.model_dir, 'checkpoints', test_model)
    print(load_path)
    ...
    env_config.save_path = os.path.join(test_args.model_dir, 'social_eval', test_model[:-3])
