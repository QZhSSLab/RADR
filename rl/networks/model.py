...
from .selfAttn_srnn_temp_graph_node import selfAttn_merge_SRNN_Graph_Node
...
class Policy(nn.Module):
    ...
    def __init__(self, obs_shape, action_space, base=None, base_kwargs=None):
        ...
        if base == 'srnn':
            ...
            base = selfAttn_merge_SRNN  # default: selfAttn_merge_SRNN selfAttn_merge_SRNN_Graph_Node
        else:
